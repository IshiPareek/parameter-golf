...
def main() -> None:
    ...
    # Remove target encoder before serialization — not needed for inference
    # Can be reconstructed as EMA copy of context encoder if training resumes
    del base_model.target_blocks
    del base_model.target_final_norm
